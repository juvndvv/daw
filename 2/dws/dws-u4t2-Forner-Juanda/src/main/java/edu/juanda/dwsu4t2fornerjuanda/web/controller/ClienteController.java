package edu.juanda.dwsu4t2fornerjuanda.web.controller;
...
import edu.juanda.dwsu4t2fornerjuanda.service.ClienteService;
...
public class ClienteController {
    ...
    // Borrar un cliente
    @GetMapping("/clientevs/delete/{idCliente}")
