...
import edu.juanda.dwsu4t2fornerjuanda.repository.dao.ClienteRepository;
import edu.juanda.dwsu4t2fornerjuanda.repository.entity.Cliente;
...
public class ClienteServiceImpl implements ClienteService {
    ...
    public List<String> save(ClienteDTO clienteDTO) {
        ...
        if (errores.isEmpty()) {
            ...
            clienteRepository.save(ClienteDTO.convertToEntity(clienteDTO));
    ...
    private static void validarNIF(String NIF, List<String> errores) {
        ...
        else if (!NIF.matches("^[0-9]{8}[A-Za-z]{1}$"))
