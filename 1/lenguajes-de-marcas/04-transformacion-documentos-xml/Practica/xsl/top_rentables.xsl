        ...
        <html>
            ...
            <body>
                ...
                <table>
                    ...
                    <!--TODO
                    se deberia de crear una variable rentabilidad paara cada cliente para asi no
                    repetir codigo en la etiqueta short-->
                    ...
                    <xsl:for-each select="cliente">
                        ...
                        <xsl:if
                            test="10* (count(/clientes/cliente)+1) div 100 > position()">
                            <tr>
                                <td>
