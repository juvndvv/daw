...
function createBuySection() {
  ...
  // Carga los articulos y los dibuja
  ARTICLES.length = 0;
  fetchAllArticles()
    .then((json) => {
...
export function drawArticles(articles) {
  const buySection = document.getElementById("articles");

  // Limpia los articulos
  document.getElementById("articles").innerHTML = "";

  if (articles.length === 0) {
    createElement(buySection, "p", "No hay articulos");
  }
