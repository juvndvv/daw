package edu.juanda.dwsu4t1fornerjuanda.web.controller;
...
import edu.juanda.dwsu4t1fornerjuanda.service.ClienteService;
@Controller
public class ClienteController {
    ...
    public ModelAndView save(@ModelAttribute("clienteDTO") ClienteDTO clienteDTO) {
        ...
        log.info("ClienteController - save: Salvamos los datos del cliente:" +
                clienteDTO.toString());
